                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        defaultValue="Introduction to Quantum Physics"
                            ...
                            <div>
                                ...
                                <textarea
                                    rows={5}
                                    defaultValue="A comprehensive introduction to quantum physics covering fundamental concepts and principles."
